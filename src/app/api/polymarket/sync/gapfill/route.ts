...
const TAG_TO_CATEGORY: Record<string, string> = {
  ...
  basketball: 'Sports', soccer: 'Sports', hockey: 'Sports', tennis: 'Sports',
  cricket: 'Sports', baseball: 'Sports', football: 'Sports', rugby: 'Sports',
  ufc: 'Sports', boxing: 'Sports', golf: 'Sports', f1: 'Sports', chess: 'Sports',
  'table-tennis': 'Sports', pickleball: 'Sports', lacrosse: 'Sports',
  nba: 'Sports', ncaab: 'Sports', wnba: 'Sports', nhl: 'Sports', nfl: 'Sports',
  ncaaf: 'Sports', mlb: 'Sports', mls: 'Sports', epl: 'Sports', ucl: 'Sports',
  'la-liga': 'Sports', 'serie-a': 'Sports', bundesliga: 'Sports', 'ligue-1': 'Sports',
  'premier-league': 'Sports', 'champions-league': 'Sports', 'europa-league': 'Sports',
  'liga-mx': 'Sports', 'copa-america': 'Sports', 'world-cup': 'Sports', euros: 'Sports',
  'counter-strike-2': 'Sports', 'dota-2': 'Sports', 'league-of-legends': 'Sports',
  valorant: 'Sports', 'honor-of-kings': 'Sports', 'call-of-duty': 'Sports',
  overwatch: 'Sports', 'rocket-league': 'Sports',
  atp: 'Sports', wta: 'Sports', ipl: 'Sports', pga: 'Sports',
  khl: 'Sports', npb: 'Sports', xfl: 'Sports', 'formula-1': 'Sports',
