...
const ESPN_LEAGUES: { tag: string; sport: string; league: string; label: string }[] = [
  ...
  { tag: 'j-league', sport: 'soccer', league: 'jpn.1', label: 'J1 League' },
  { tag: 'japan-j-league', sport: 'soccer', league: 'jpn.1', label: 'Japan J League' },
  { tag: 'a-league', sport: 'soccer', league: 'aus.1', label: 'A-League' },
  { tag: 'nwsl', sport: 'soccer', league: 'usa.nwsl', label: 'NWSL' },
  { tag: 'concacaf-champions-league', sport: 'soccer', league: 'concacaf.champions', label: 'CONCACAF Champions League' },
  { tag: 'afc-champions-league', sport: 'soccer', league: 'afc.champions', label: 'AFC Champions League' },
  { tag: 'copa-libertadores', sport: 'soccer', league: 'conmebol.libertadores', label: 'Copa Libertadores' },
  { tag: 'copa-sudamericana', sport: 'soccer', league: 'conmebol.sudamericana', label: 'Copa Sudamericana' },
  { tag: 'scottish-premiership', sport: 'soccer', league: 'sco.1', label: 'Scottish Premiership' },
  { tag: 'primeira-liga', sport: 'soccer', league: 'por.1', label: 'Primeira Liga' },
  { tag: 'belgian-pro-league', sport: 'soccer', league: 'bel.1', label: 'Belgian Pro League' },
